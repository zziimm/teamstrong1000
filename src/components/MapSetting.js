...
function MapSetting(props) {
  ...
  useEffect(() => {
    axios.get(`https://api.odcloud.kr/api/15089659/v1/uddi:9b78da91-c003-47c0-a828-f370fa41b851?page=1&perPage=10&serviceKey=${process.env.REACT_APP_MAP_SERVICEKEY}`)
    .then((response) => {
